...
var dragHandleInitialTop = '45vh';
	...
	$(obj).prepend('<div id="dragwrapper'+randID+'"><div id="drag'+randID+'"><div id="draghandle'+randID+'" className="drag_handle"></div></div></div>'); // Create drag handle
	...
	if (o.ltImagePath !== undefined) {
		$(obj).append('<img src="'+o.ltImagePath + '" className="drag_arrow" id="lt-arrow'+randID+'">');
	}
	if (o.rtImagePath !== undefined) {
		$(obj).append('<img src="'+o.rtImagePath + '" className="drag_arrow" id="rt-arrow'+randID+'">');
	}
	...
	/*
	  if(o.showFullLinks)
	  {
	  $(obj).after('<div className="balinks" id="links'+randID+'" style="position:relative"><span className="balinks"><a id="showleft'+randID+'" href="javascript:void(0)">'+o.beforeLinkText+'</a></span><span className="balinks"><a id="showright'+randID+'" href="javascript:void(0)">'+o.afterLinkText+'</a></span></div>');
